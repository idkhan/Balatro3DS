...
function Game:point_in_rect(px, py, node)
    ...
    local x, y, w, h = t.x, t.y, t.w * t.scale, t.h * t.scale
...
function Game:touchreleased(id, x, y)
    if self.dragging and self.dragging.touchreleased then
        self.dragging:touchreleased(id, x, y)
    end
    self.dragging = nil
end
...
function Game:set_render_settings()
    ...
    love.graphics.setLineStyle("rough")
        ...
        self.asset_atli = {
            ...
            {name = "Joker", path = "resources/textures/"..self.SETTINGS.GRAPHICS.texture_scaling.."x/Jokers.png",px=72,py=95},
